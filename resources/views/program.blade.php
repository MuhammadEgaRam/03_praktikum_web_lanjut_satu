    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="#page-top">Start Your Adventure</a>
        ...
        <header class="bg-primary bg-gradient text-white">
            <div class="container px-4 text-center">
                <h1 class="fw-bolder">Welcome back Egaram</h1>
        ...
        <section id="produk">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h2>Produk 1</h2>
                        <p class="lead">This is a great place to talk about your webpage. This is template for my product 1 :</p>
                        <div class="question-box">
                            <h2>Q1. Information Input Box</h2>
                            <h5>1-1. Alert the input value as you press the button</h5>
                            <h5>1-2. Alert "Insert any value!" when the input value is empty</h5>
                            <input id="input-q1" type="text" /> <button onclick="q1()">Submit</button>
                        </div>
                        <hr />
                    </div>
                </div>
            ...
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="row me-row content-ct">
                        <h2 class="row-title">Produk 2</h2>
            ...
            <div class="container px-4">
                ...
                <div class="row hero-header" id="home">
                    <div class="col-md-7">
                        ...
                        <h1>Berita Terpanas Hari Ini 2023</h1>
                        <h3>Gacha Berita : </h3>
                        <h4>08<sup>th</sup> Maret, 2023</h4>
                        <a href="#" class="btn btn-lg btn-red">Menuju Berita <span class="ti-arrow-right"></span></a>
                    </div>
        ...
        <section id="program">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="row me-row content-ct">
                        <h2 class="row-title">Program 1</h2>
                        <div class="container-fluid tickets" id="tickets">
                            <div class="row me-row content-ct">
                            <h2 class="row-title">Program Donasi</h2>
                            <div class="col-md-4 col-sm-6 col-md-offset-2">
                                <h3>Anak Yatim Piatu</h3>
                                <p class="price">Rp. 10.000</p>
                                <p>Monggo bisa donasi seiklasnya</p>
                                <a href="#" class="btn btn-lg btn-red">Buy <small>(Monggo)</small></a>
                            </div>
        ...
        <section id="program">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="row me-row content-ct">
                        <h2 class="row-title">Program 2</h2>
                        <div class="container-fluid tickets" id="tickets">
                            <div class="row me-row content-ct">
